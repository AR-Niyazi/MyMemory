...
import com.niyazi1.mymemory.utils.*
import com.niyazi1.mymemory.R
...
class CreateActivity : AppCompatActivity() {
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == READ_EXTERNAL_PHOTOS_CODE) {
            if (grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(this, "In order to create a custom game, you need to provide access to your photos", LENGTH_LONG).show()
            }
        }
    ...
    private fun saveDataToFirebase() {
        ...
        // Check that we're not writing someone else's data
